    ...
    class Generator
    {
        ...
        private static void generateShops(Configuration _conf, string _path)
        {
            ...
            try
            {
                ...
                if (_conf.itemPropertiesInShops.Contains("ID")) twShops.WriteLine("\t\t\tvar shop_str += \"<td class=\\\"shop\\\"><b>" + _conf.captions.Single(s => s.captionName.Equals("SHOP_COL_ID_CAP")).caption + "</b></td>\";");
                if (_conf.itemPropertiesInShops.Contains("Name")) twShops.WriteLine("\t\t\tvar shop_str += \"<td class=\\\"shop\\\"><b>" + _conf.captions.Single(s => s.captionName.Equals("SHOP_COL_NAME_CAP")).caption + "</b></td>\";");
                if (_conf.itemPropertiesInShops.Contains("Quantity")) twShops.WriteLine("\t\t\tvar shop_str += \"<td class=\\\"shop\\\"><b>" + _conf.captions.Single(s => s.captionName.Equals("SHOP_COL_QUANTITY_CAP")).caption + "</b></td>\";");
                if (_conf.itemPropertiesInShops.Contains("Buy")) twShops.WriteLine("\t\t\tvar shop_str += \"<td class=\\\"shop\\\"><b>" + _conf.captions.Single(s => s.captionName.Equals("SHOP_BUY_CAP")).caption + "</b></td>\";");
                if (_conf.itemPropertiesInShops.Contains("Sell")) twShops.WriteLine("\t\t\tvar shop_str += \"<td class=\\\"shop\\\"><b>" + _conf.captions.Single(s => s.captionName.Equals("SHOP_SELL_CAP")).caption + "</b></td>\";");
                if (_conf.itemPropertiesInShops.Contains("Skill1") && _conf.shopUseSkill1) twShops.WriteLine("\t\t\tvar shop_str += \"<td class=\\\"shop\\\"><b>" + _conf.captions.Single(s => s.captionName.Equals("SHOP_COL_SKILL1_CAP")).caption + "</b></td>\";");
                if (_conf.itemPropertiesInShops.Contains("Skill2") && _conf.shopUseSkill2) twShops.WriteLine("\t\t\tvar shop_str += \"<td class=\\\"shop\\\"><b>" + _conf.captions.Single(s => s.captionName.Equals("SHOP_COL_SKILL2_CAP")).caption + "</b></td>\";");
                if (_conf.itemPropertiesInShops.Contains("Skill3") && _conf.shopUseSkill3) twShops.WriteLine("\t\t\tvar shop_str += \"<td class=\\\"shop\\\"><b>" + _conf.captions.Single(s => s.captionName.Equals("SHOP_COL_SKILL3_CAP")).caption + "</b></td>\";");
